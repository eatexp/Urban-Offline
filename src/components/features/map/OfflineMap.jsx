            ...
            <div className="absolute bottom-6 right-6 flex flex-col gap-4 z-10 print:hidden">
                ...
                <div className="flex flex-col bg-slate-900/90 backdrop-blur-md border border-slate-700/50 rounded-full overflow-hidden shadow-lg">
                    <button
                        ...
                        className="w-12 h-12 flex items-center justify-center text-slate-400 border-b border-slate-800 active:bg-slate-800 transition-colors"
                        aria-label="Zoom in"
                        title="Zoom in"
                    >
                        <Plus size={20} />
                    ...
                    <button
                        onClick={() => handleZoom(-1)}
                        className="w-12 h-12 flex items-center justify-center text-slate-400 active:bg-slate-800 transition-colors"
                        aria-label="Zoom out"
                        title="Zoom out"
                    >
                        <Minus size={20} />
