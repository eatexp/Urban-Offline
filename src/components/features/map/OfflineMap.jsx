        ...
        <div className="relative w-full h-full bg-slate-950 overflow-hidden">
            ...
            <div className="absolute bottom-6 right-6 flex flex-col gap-4 z-10 print:hidden">
                ...
                <div className="flex flex-col bg-slate-900/90 backdrop-blur-md border border-slate-700/50 rounded-full overflow-hidden shadow-lg">
                    <button onClick={() => handleZoom(1)} aria-label="Zoom in" className="w-12 h-12 flex items-center justify-center text-slate-400 border-b border-slate-800 active:bg-slate-800 transition-colors">
                        <Plus size={20} />
                    </button>
                    <button onClick={() => handleZoom(-1)} aria-label="Zoom out" className="w-12 h-12 flex items-center justify-center text-slate-400 active:bg-slate-800 transition-colors">
                        <Minus size={20} />
                    </button>
                </div>
            </div>
