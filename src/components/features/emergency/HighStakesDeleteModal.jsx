...
const HighStakesDeleteModal = ({
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- clearTimers is stable (useCallback with [])
  }, []);
  ...
  const handleClose = useCallback(() => {
    ...
    onClose();
  }, [isDeleting, clearTimers, onClose]);
  ...
  }, [isDeleting, onConfirm, handleClose]);
  ...
  }, [isDeleting, isLongPressing, clearTimers]);

  // Use ref to stay current with handleConfirm without re-triggering effects
...
// eslint-disable-next-line react-refresh/only-export-components -- shared utility function
