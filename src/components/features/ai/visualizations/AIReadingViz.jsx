                        ...
                        return (
                            ...
                            >
                                ...
                                <motion.div
                                    ...
                                    transition={{ duration: 1, repeat: Infinity }}
                                    className={`absolute left-2 top-1 w-5 h-5 rounded-full flex items-center justify-center ${isCurrent ? config.bgColor : 'bg-white/10'
                                ...
                                {/* Stage content */}
                                <div className={`p-3 rounded-xl border ${isCurrent ? config.borderColor : 'border-white/5'} ${isCurrent ? config.bgColor : 'bg-white/5'
                                    }`}>
