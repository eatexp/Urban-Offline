...
const Guides = () => {
    ...
    const loadGuides = async () => {
        try {
            ...
            log.error('Failed to load guides', error);
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleInstall = async (id) => {
        try {
            ...
            log.error('Failed to install guide', error);
        }
    };
    ...
    const handleUninstall = async (id) => {
        try {
            ...
            log.error('Failed to uninstall guide', error);
        }
    };
    ...
    const handleView = async (id) => {
        try {
            ...
            log.error('Failed to open guide', error);
        }
    };
