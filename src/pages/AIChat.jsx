                ...
                <header className="px-4 py-3 lg:px-6" style={{ background: 'var(--color-bg-glass)', backdropFilter: 'blur(16px)', borderBottom: '1px solid var(--color-border-primary)' }}>
                    <div className="flex items-center justify-between max-w-4xl mx-auto">
                        <div className="flex items-center gap-3">
                            <button aria-label="Menu" title="Menu" onClick={() => setShowHistory(true)} className="p-2 rounded-lg hover:bg-[var(--color-bg-tertiary)] transition-colors">
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            <button aria-label="AI Data Flow" title="AI Data Flow" onClick={() => setShowVisualizations(!showVisualizations)} className={`p-2 rounded-lg transition-colors ${showVisualizations ? 'bg-[var(--color-bg-tertiary)] text-primary-400' : 'text-[var(--color-text-muted)]'}`}><Activity className="w-5 h-5" /></button>
