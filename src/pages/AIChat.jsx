                ...
                <header className="px-4 py-3 lg:px-6" style={{ background: 'var(--color-bg-glass)', backdropFilter: 'blur(16px)', borderBottom: '1px solid var(--color-border-primary)' }}>
                    <div className="flex items-center justify-between max-w-4xl mx-auto">
                        <div className="flex items-center gap-3">
                            <button aria-label="Chat history" title="Chat history" onClick={() => setShowHistory(true)} className="p-2 rounded-lg hover:bg-[var(--color-bg-tertiary)] transition-colors">
                        ...
                        <div className="flex items-center gap-1">
                            <button aria-label="AI Models" title="AI Models" onClick={() => navigate('/ai-models')} className="p-2 rounded-lg transition-colors hover:bg-[var(--color-bg-tertiary)] text-[var(--color-text-muted)]"><Cpu className="w-5 h-5" /></button>
                            <button aria-label="Toggle visualizations" title="Toggle visualizations" onClick={() => setShowVisualizations(!showVisualizations)} className={`p-2 rounded-lg transition-colors ${showVisualizations ? 'bg-[var(--color-bg-tertiary)] text-primary-400' : 'text-[var(--color-text-muted)]'}`}><Activity className="w-5 h-5" /></button>
                            <button aria-label="Dataset settings" title="Dataset settings" onClick={() => setShowDatasetSettings(true)} className="p-2 rounded-lg transition-colors hover:bg-[var(--color-bg-tertiary)] text-[var(--color-text-muted)]"><Settings className="w-5 h-5" /></button>
                        </div>
                    </div>
                </header>
