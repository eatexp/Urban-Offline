                ...
                <header className="px-4 py-3 lg:px-6" style={{ background: 'var(--color-bg-glass)', backdropFilter: 'blur(16px)', borderBottom: '1px solid var(--color-border-primary)' }}>
                    <div className="flex items-center justify-between max-w-4xl mx-auto">
                        <div className="flex items-center gap-3">
                            <button onClick={() => setShowHistory(true)} className="p-2 rounded-lg hover:bg-[var(--color-bg-tertiary)] transition-colors" aria-label="Toggle sidebar" title="Toggle sidebar">
                        ...
                        <div className="flex items-center gap-1">
                            <button onClick={() => navigate('/ai-models')} className="p-2 rounded-lg transition-colors hover:bg-[var(--color-bg-tertiary)] text-[var(--color-text-muted)]" aria-label="Manage AI Models" title="Manage AI Models"><Cpu className="w-5 h-5" /></button>
                            <button onClick={() => setShowVisualizations(!showVisualizations)} className={`p-2 rounded-lg transition-colors ${showVisualizations ? 'bg-[var(--color-bg-tertiary)] text-primary-400' : 'text-[var(--color-text-muted)]'}`} aria-label="Toggle AI Visualizations" title="Toggle AI Visualizations"><Activity className="w-5 h-5" /></button>
                            <button onClick={() => setShowDatasetSettings(true)} className="p-2 rounded-lg transition-colors hover:bg-[var(--color-bg-tertiary)] text-[var(--color-text-muted)]" aria-label="Dataset Settings" title="Dataset Settings"><Settings className="w-5 h-5" /></button>
                        </div>
                    </div>
                </header>
